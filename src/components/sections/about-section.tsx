				...
				<div className='grid w-full min-w-0 gap-8 md:gap-12 lg:grid-cols-2 lg:items-center'>
					<TiltCard maxTilt={6}>
						<motion.div
							...
							<h3 className='text-2xl font-semibold tracking-tight text-primary-content'>{personalInfo.name}</h3>
							<p className='mt-2 font-medium text-accent'>{personalInfo.role}</p>
							<p className='mt-6 leading-relaxed text-secondary-content'>{translate('about.intro')}</p>
						</motion.div>
					</TiltCard>
