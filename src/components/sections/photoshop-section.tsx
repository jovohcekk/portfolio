...
import {
  ...
  type PhotoshopCategory,

} from "@/config/portfolio";

import { staggerContainerFast, slideInScale } from "@/lib/animations";
...
export function PhotoshopSection() {
  ...
  const [activeFilter, setActiveFilter] = useState<PhotoshopCategory | "all">("all");
  ...
  const filteredProjects = useMemo(
    ...
    () =>
      ...
      activeFilter === "all"
        ...
        : photoshopProjects.filter((p) => p.category === activeFilter),
    ...
    >
      ...
      <div className="section-container relative z-10">
        ...
        <SectionHeading
          ...
          subtitle={translate("photoshop.subtitle")}
        ...
        <motion.div
          ...
          className="mb-8 flex w-full min-w-0 flex-wrap justify-center gap-2 xs:mb-10 xs:gap-2.5"

        >

          {photoshopCategories.map((cat) => (
            ...
            <motion.button
              ...
              className={cn(
                ...
                "rounded-full px-3 py-1.5 text-xs font-medium transition-all duration-300 xs:px-4 xs:py-2 xs:text-sm",

                activeFilter === cat.id

                  ? isDark

                    ? "border border-red-500/40 bg-red-500/20 text-red-400 shadow-[0_0_20px_rgba(220,38,38,0.25)]"

                    : "border border-[var(--border-glow)] bg-[rgb(var(--accent-primary)/0.1)] text-accent shadow-[0_2px_12px_rgba(59,130,246,0.1)]"

                  : isDark

                    ? "border border-white/10 bg-white/5 text-white/60 hover:border-red-500/30 hover:text-white/90"
            ...
            >
              ...
              {translate(cat.labelKey as TranslationKey)}
                      ...
                      <motion.div
                        ...
                        className={cn(
                          ...
                          isDark
                            ...
                            : "from-[var(--bg-deep)]/90 via-[var(--bg-deep)]/35"
